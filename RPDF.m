...
for i = 1:num_alpha
    ...
    % apply alpha scaling to tpdf
    test_tpdf = alpha * d_rpdf;

    x_dithered = x + test_tpdf;

    y = quantizer(x_dithered, q);
...
% scatter plot for VISQO L vs Entropy
